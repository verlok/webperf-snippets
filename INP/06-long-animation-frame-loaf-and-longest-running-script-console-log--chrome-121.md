...
The following code works from Chrome 121 on, but if you are on Chrome 122 you should just use the [non-polyfilled version of this cript](./06-long-animation-frame-loaf-and-longest-running-script-console-log--chrome-122.md).
