...
- [06 - Log to console long animation frame (LoAF) and the longtest running script - for all Chrome versions](./INP/06-long-animation-frame-loaf-and-longest-running-script-console-log--chrome-121.md)
- [06 - Log to console long animation frame (LoAF) and the longtest running script - for Chrome 122+](./INP/06-long-animation-frame-loaf-and-longest-running-script-console-log--chrome-122.md)

## LCP

- [Get the LCP candidates.js](./LCP/01-GetLCPCandidates.js)